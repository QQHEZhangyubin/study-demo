package com.example.desk.ui.webpreview;
...
public class WebPreviewActivity extends MVPBaseActivity<WebPreviewContract.View, WebPreviewPresenter> implements WebPreviewContract.View {
    ...
    RelativeLayout activityWebPreview;
