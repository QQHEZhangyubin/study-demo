...
public class ImagePagerActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (showDelete) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ImagePagerActivity2.this);
                    ...
                    builder.setNegativeButton("确定", (d, p) -> {
                       ...
                       /* mAdapter.setDatas(imgUrls);
                        ...
                        mAdapter = new ImageAdapter(ImagePagerActivity2.this, showDelete);
                        mAdapter.setDatas(imgUrls);
