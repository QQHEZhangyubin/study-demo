...
public class ImagePagerFragment extends Fragment {
  ...
  private void runEnterAnimation() {
    ...
    com.nineoldandroids.animation.ObjectAnimator bgAnim = com.nineoldandroids.animation.ObjectAnimator.ofInt(mViewPager.getBackground(), "alpha", 0, 255);
  ...
  public void runExitAnimation(final Runnable endAction) {
    ...
    // Fade out background
    com.nineoldandroids.animation.ObjectAnimator bgAnim = com.nineoldandroids.animation.ObjectAnimator.ofInt(mViewPager.getBackground(), "alpha", 0);
    bgAnim.setDuration(duration);
    bgAnim.start();

    // Animate a color filter to take the image back to grayscale,
    // in parallel with the image scaling and moving into place.
    com.nineoldandroids.animation.ObjectAnimator colorizer =
        com.nineoldandroids.animation.ObjectAnimator.ofFloat(ImagePagerFragment.this, "saturation", 1, 0);
    colorizer.setDuration(duration);
    colorizer.start();
  }
